...
namespace DSCC_CW_MVC_5758.Controllers
{
    public class ProductController : Controller
    {
        ...
        private List<Product> Get()
        {
            try
            {
                ...
                var getDataTask = client.GetAsync("https://localhost:44353/api/product").ContinueWith(response => {
        ...
        public ActionResult Create(Product product)
        {
            ...
            {
                client.BaseAddress = new Uri("https://localhost:44353/api/product");
        ...
        public ActionResult Edit(Product product)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri("https://localhost:44353/api/product/" + product.Id);
